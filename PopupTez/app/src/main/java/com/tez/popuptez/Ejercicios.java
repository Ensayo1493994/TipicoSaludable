...
public class Ejercicios extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        https://cdn6.aptoide.com/imgs/1/8/3/183a78d368593623e4059d33860b41ca_icon.png?w=240

        brazo=(ImageButton)findViewById(R.id.brazo);
        String ImageBrazo ="https://scontent-sjc3-1.xx.fbcdn.net/v/t1.0-9/44329409_116269619355805_2198198450032476160_n.jpg?_nc_cat=110&oh=16fd5314c43a06deec2a48b323f0b46c&oe=5C533A91";
        Glide.with(this)
                .load(ImageBrazo)
                .crossFade()
                .centerCrop()
        ...
        saltar=(ImageButton)findViewById(R.id.saltar);
        ...
        sentado=(ImageButton)findViewById(R.id.sentado);
        ...
        titere=(ImageButton)findViewById(R.id.titere);
        ...
        abd=(ImageButton)findViewById(R.id.abd);
        ...
        burpes=(ImageButton)findViewById(R.id.burpes);
        ...
        climber=(ImageButton)findViewById(R.id.climber);
        ...
        impulso=(ImageButton)findViewById(R.id.impulso);
...
//--------------------------------------------------------------------------------------------------------------------------------
    ...
    public void ShowBrazo(){
        ...
        btnBra1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Ejercicios.this, "!! Muy Bien ¡¡", Toast.LENGTH_SHORT).show();
                epicDialog.dismiss();
            }
        });
        ...
        btnBra2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Ejercicios.this, "!! Muyy Maalll ¡¡", Toast.LENGTH_SHORT).show();
                epicDialog.dismiss();
            }
        });
        //Cerrar-------------------------------------------------------------------------------
    ...
    public void ShowSentadilla(){
        epicDialog.setContentView(R.layout.sentado_alert);
