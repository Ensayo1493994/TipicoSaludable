...
public class Deportes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String ImageTitulo ="https://yourbestsports.files.wordpress.com/2018/01/icon-ropa-deporte1.png?w=350";
        Glide.with(this)
                .load(ImageTitulo)
                .crossFade()
                .centerCrop()
    ...
    public void ShowFutbol() {
        ...
        String url ="https://previews.dropbox.com/p/orig/AAMFj-9wxzQrRFRrdliAZaVAQlKk-lGjpOezX2eYkQuflDbaQwYMXyNhuFkf9U1h_PqVcPM3MiOmdEKVPRWhOgbAcThdX-5xloCDuQ0BZgDFgjX2ibA5dT5MJjn9TTIDtNCT4InIDQTEv-79G0Zx1Vz3/p.gif?size=1280x960&size_mode=3";
        Glide.with(this)
                .load(url)
                .crossFade()
                .centerCrop()
