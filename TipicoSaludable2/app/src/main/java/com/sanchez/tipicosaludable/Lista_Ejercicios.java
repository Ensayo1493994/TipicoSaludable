...
public class Lista_Ejercicios extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_lista__ejercicios, container, false);
        epicDialog = new Dialog(getContext());

        // Iconos de de titulos--------------------------------------------------------------------------------------------------------------------------------------------
        Titulo1=(ImageView)vista.findViewById(R.id.Titulo1);
        ...
        Titulo2=(ImageView)vista.findViewById(R.id.Titulo2);
        ...
        Titulo3=(ImageView)vista.findViewById(R.id.Titulo3);
        ...
        Men_Brazo=(ImageButton)vista.findViewById(R.id.Men_Brazo);
        ...
        Men_saltos=(ImageButton)vista.findViewById(R.id.Men_Saltos);
        ...
        Men_sentadilla=(ImageButton)vista.findViewById(R.id.Men_Sentadilla);
        ...
        Men_titere=(ImageButton)vista.findViewById(R.id.Men_Titere);
        ...
        Men_abd=(ImageButton)vista.findViewById(R.id.Men_Abd);
        ...
        Men_burpes=(ImageButton)vista.findViewById(R.id.Men_Burpes);
        ...
        Men_climber=(ImageButton)vista.findViewById(R.id.Men_Climber);
        ...
        Men_impulso=(ImageButton)vista.findViewById(R.id.Men_Salto_Impulso);
        ...
        Men_marchar=(ImageButton)vista.findViewById(R.id.Men_Marcha);
        ...
        Men_zumba=(ImageButton)vista.findViewById(R.id.Men_Zumba);
        ...
        Men_pilates=(ImageButton)vista.findViewById(R.id.Men_Pilates);
        ...
        Men_yoga=(ImageButton)vista.findViewById(R.id.Men_Yoga);
        ...
        Men_step=(ImageButton)vista.findViewById(R.id.Men_Step);
        ...
        Men_caminar=(ImageButton)vista.findViewById(R.id.Men_Caminar);
        ...
        Men_trotar=(ImageButton)vista.findViewById(R.id. Men_Trotar);
        ...
        Men_aerobicos=(ImageButton)vista.findViewById(R.id. Men_Aerobicos);
        ...
        Men_spinning=(ImageButton)vista.findViewById(R.id. Men_Spinninng);
        ...
        Men_futbol=(ImageButton)vista.findViewById(R.id.Men_Futbol);
        ...
        Men_natacion=(ImageButton)vista.findViewById(R.id.Men_Natacion);
        ...
        Men_ciclismo=(ImageButton)vista.findViewById(R.id.Men_Ciclismo);
        ...
        Men_patinaje=(ImageButton)vista.findViewById(R.id.Men_Patinaje);
        ...
        Men_baloncesto=(ImageButton)vista.findViewById(R.id.Men_Baloncesto);
