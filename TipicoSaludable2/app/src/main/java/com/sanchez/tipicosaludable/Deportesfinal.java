...
public class Deportesfinal extends Fragment {
    Dialog epicDialog;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_deportesfinal, container, false);
        ...
        ciclismo=(ImageButton)vista.findViewById(R.id.ciclismo);
        ...
        patinaje=(ImageButton)vista.findViewById(R.id.patinaje);
        ...
        Glide.with(this)
                ...
                .thumbnail(0.5f)
                .into(patinaje);
        baloncesto=(ImageButton)vista.findViewById(R.id.baloncesto);
