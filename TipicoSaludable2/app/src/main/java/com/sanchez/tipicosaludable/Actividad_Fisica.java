...
public class Actividad_Fisica extends Fragment {
    Dialog epicDialog;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_actividad__fisica, container, false);

        epicDialog = new Dialog(getContext());

        Titulo=(ImageView)vista.findViewById(R.id.Titulo);
        String ImageTitulo ="https://firebasestorage.googleapis.com/v0/b/popuptez.appspot.com/o/Actividad.png?alt=media&token=fbe52a9e-affd-439d-baa4-fd389fd7b9ab";
        Glide.with(this)
                .load(ImageTitulo)
                .crossFade()
                .centerCrop()
        ...
        //ImagButtons
        marchar=(ImageButton)vista.findViewById(R.id.marcha);
        ...
        zumba=(ImageButton)vista.findViewById(R.id.zumba);
        ...
        pilates=(ImageButton)vista.findViewById(R.id.pilates);
        ...
        yoga=(ImageButton)vista.findViewById(R.id.yoga);
        ...
        step=(ImageButton)vista.findViewById(R.id.step);
        ...
        caminar=(ImageButton)vista.findViewById(R.id.caminar);
        ...
        trotar=(ImageButton)vista.findViewById(R.id.trotar);
        ...
        aerobicos=(ImageButton)vista.findViewById(R.id.aerobicos);
        ...
        spinning=(ImageButton)vista.findViewById(R.id.spininng);
